...
#         end
#
#         it 'loops until it IS a valid move' do
#           expect(game).to have_received(:valid_move?).twice
#           expect(game).to have_received(:invalid_selection)
#           expect(game).to have_received(:pick_a_column).twice
#           expect(game).to have_received(:place_chip_in_column)
#
#         end
...
#         # end
#         #
#         # it 'picks a column again' do
#         #
#         #
#         # end
#         # it 'places chip in column for valid move' do
#         #   expect(game).to have_received(:place_chip_in_column)
#         #
#         # end
#       end
